export const caseStudies = [
  {
    ...
    confidential: true,
    chapters: [
      { label: "Discovery", title: "Dense content, rewritten as a journey.", body: "The product's knowledge base was accurate but exhausting: long pages, no sense of progress, no reason to return. The first move was structural — auditing the full content library and rebuilding it as progressive learning modules with a clear beginning, middle, and end, so users always know where they are and what's next." },
      { label: "System", title: "Gamification that serves comprehension.", body: "Progress mechanics, staged challenges, and completion states were designed around learning outcomes rather than decoration. The restructured modules lifted task completion by 25% and cut early-stage drop-off by 40% — the game layer works because the information architecture underneath it is sound." },
      { label: "Craft", title: "AI-accelerated, design-led.", body: "AI-automated design workflows across 10+ features compressed time-to-prototype by 50% without giving up fidelity or system coherence. Technical constraints were flagged with engineering during early wireframing — avoiding two late-stage redesigns before anything shipped." },
    ],
  },
  {
    slug: "eye-ai",
    ...
    role: "UX Designer",
    titleLines: ["Diagnostic workflows and", "automated reporting for clinicians."],
    ...
    overview: "A regulated B2B health-tech MVP followed end to end — from heuristic evaluation and stakeholder research through journey mapping, iterative prototyping, and high-fidelity delivery of a diagnostic tool clinicians could trust.",
    chapters: [
  ...
  },
  {
    ...
    titleLines: ["Zoe, an AI companion", "inside a health-tech platform."],
    ...
    overview: "Primary designer for Zoe — an AI companion inside the MyoCircle health-tech SaaS platform — plus mobile onboarding, a patient management dashboard, and provider monitoring, validated across 20+ sessions with patients, parents, and providers.",
    chapters: [
      { label: "Interaction", title: "Designing an AI companion from the ground up.", body: "Zoe's interaction layer was built from zero: mapping interaction models to user inputs and care touch-points so encouragement felt timely rather than noisy. The work lifted exercise tutorial completion by 28% and weekly engagement by 30%.", images: [
      ...
      { label: "System", title: "A library the whole team could build with.", body: "A 100+ component Figma library became the shared language of the product team — adopted by product managers and engineers for independent prototyping, which kept design quality consistent even when design wasn't in the room." },
      { label: "Validation", title: "Tested with patients, parents, and providers.", body: "Twenty-plus usability testing and heuristic evaluation sessions across all three user groups surfaced where onboarding lost people — cutting drop-off among parents by 20% and grounding every major flow in observed behaviour." },
    ],
  },
  {
    slug: "travelogue",
    ...
    metrics: [["08", "Research insights"], ["03", "Core flows designed"], ["01", "End-to-end concept"]],
    ...
    chapters: [
      ...
      { label: "Concept", title: "A trip hub, not another list app.", body: "Each trip becomes a hub: the people coming, the locations on a map, an itinerary nexus with dates and details, documents one tap away, and a shared gallery. Group trips stop living in chat threads — everyone sees the same plan.", images: [
      ...
      { label: "Field note", title: "Designed for the road.", body: "The compass states it plainly: travel tools are used outdoors, one-handed, in bad light. Contrast, large touch targets, and glanceable typography were non-negotiable constraints, not polish.", images: [
  ...
  },
  {
    ...
    chapters: [
      { label: "Workflow", title: "An AI-assisted production pipeline.", body: "Built a repeatable workflow that moved from copy to mockups to finished social and print assets with AI tooling doing the heavy lifting between checkpoints — freeing time for the judgement calls that actually separate good brand work from generated noise." },
      { label: "Consistency", title: "1,000+ assets, one standard.", body: "Maintained brand standards across more than a thousand assets and twenty-five concurrent clients. The system — templates, tokens, and review gates — is what made volume and consistency compatible." },
      { label: "Growth", title: "Design that won business.", body: "Designed the brand pitch decks used directly in client acquisition, contributing to five or more new client wins — proof that production craft and business outcomes are the same conversation." },
    ],
  },
];
